class Player:
    def __init__(self, _lastName, _firstName, _fullName, _Countries, _born, _died=0):
    ...
    def __str__(self):
        return f"Player Name {self.fullName} was born in the year {self.birth()} and has represented {self.countries}. " \
               f"{self.firstName} {self.living()}."
